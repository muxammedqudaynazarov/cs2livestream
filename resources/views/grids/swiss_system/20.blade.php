    ...
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex gap-8 sm:gap-12 min-w-max pb-4">
                <div class="flex flex-col w-64 gap-3 relative shrink-0">
                    <div class="text-center mb-5">
                        ...
                        <span
                            class="text-[10px] font-bold bg-slate-100 text-slate-600 px-3 py-1 rounded-full mt-1.5 inline-block border border-slate-200 shadow-sm">Balans: 0-0</span>
                    </div>
                    @for($i=1; $i<=10; $i++)
                        <div
                            ...
                            <div class="flex justify-between items-center px-3 py-2.5 bg-slate-50">
                                ...
                                <span class="text-xs font-bold text-slate-400">9</span>
                            </div>
                        </div>
                    @endfor
                </div>

                <div class="flex flex-col w-64 gap-12 relative justify-center shrink-0">
                    <div class="flex flex-col gap-3 relative">
                        <div class="text-center mb-2">
                            <h3 class="text-sm font-black text-blue-600 uppercase tracking-widest">Round 2 (upper)</h3>
                            <span
                                class="text-[10px] font-bold bg-blue-50 text-blue-600 px-3 py-1 rounded-full mt-1.5 inline-block border border-blue-200 shadow-sm">Balans: 1-0</span>
                        </div>
                        @for($i=1; $i<=5; $i++)
                            <div
                    ...
                    <div class="flex flex-col gap-3 relative">
                        <div class="text-center mb-2">
                            ...
                            <span
                                class="text-[10px] font-bold bg-rose-50 text-rose-600 px-3 py-1 rounded-full mt-1.5 inline-block border border-rose-200 shadow-sm">Balans: 0-1</span>
                        </div>
                        @for($i=1; $i<=5; $i++)
                            <div
                ...
                <div class="flex flex-col w-64 gap-10 relative justify-center shrink-0">
                    ...
                    <div class="flex flex-col gap-3 relative">
                        <div class="text-center mb-2">
                            <h3 class="text-sm font-black text-amber-600 uppercase tracking-widest">Round 3
                                (middle)</h3>
                            <span
                                class="text-[10px] font-bold bg-amber-50 text-amber-600 px-3 py-1 rounded-full mt-1.5 inline-block border border-amber-200 shadow-sm">Balans: 1-1</span>
                        </div>
                        @for($i=1; $i<=6; $i++)
                            <div
                ...
                <div class="flex flex-col w-64 relative justify-center shrink-0">
                    <div
                        class="flex flex-col gap-3 relative p-5 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border-2 border-slate-700 shadow-lg relative overflow-hidden">
                        <div class="absolute -right-4 -top-4 text-slate-700 opacity-50 pointer-events-none">
                            <i class="fa-solid fa-khanda text-8xl"></i>
                        </div>
                        <div class="text-center mb-2 mt-1 relative z-10">
                            <div
                                class="inline-block px-3 py-1 bg-amber-500 text-slate-900 text-[10px] font-black uppercase rounded-full shadow-sm mb-2">
                                <i class="fa-solid fa-ticket mr-1"></i> Play-in
                            </div>
                            <h3 class="text-sm font-black text-white uppercase tracking-widest">Round 6</h3>
                        </div>
                        <p class="text-[10px] text-center text-slate-400 font-bold mb-4 uppercase tracking-wide relative z-10">
                            Pley-off 1/4 Final ushın (BO3)</p>

                        <div class="relative z-10 space-y-3">
                            @for($i=1; $i<=2; $i++)
                                <div
                                    class="bg-slate-800 border-2 border-slate-600 rounded-xl shadow-md overflow-hidden flex flex-col transform hover:-translate-y-1 hover:border-amber-500 transition-all">
                                    <div class="flex justify-between items-center px-4 py-3 border-b border-slate-700">
                                        <span class="text-xs font-bold text-white">3-2 Komanda</span>
                                        <div class="flex items-center gap-2">
                                            <span class="text-[10px] font-black text-amber-500">BO3</span>
                                            <span class="text-xs font-black text-white w-3 text-right">2</span>
                                        </div>
                                    </div>
                                    <div class="flex justify-between items-center px-4 py-3 bg-slate-800/50">
                                        <span class="text-xs font-bold text-slate-300">3-2 Komanda</span>
                                        <div class="flex items-center gap-2">
                                            <span class="text-[10px] font-black opacity-0">BO3</span>
                                            <span class="text-xs font-bold text-slate-400 w-3 text-right">1</span>
                                        </div>
        ...
        <div class="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-5 flex items-center gap-4">
                ...
                <div>
                    <h4 class="text-sm font-black text-emerald-900">Pley-offqa ótiw</h4>
                    <p class="text-xs font-medium text-emerald-700 mt-1">
                        Jámi 8 komanda shıǵadı: 6 komanda tuwrıdan-tuwrı 1/4 finalǵa,
                        4 komandadan ekewi Round 6 arqalı 1/4 final ushın gúresedi.
                    </p>
                </div>
            </div>
            <div class="bg-rose-50 border border-rose-200 rounded-xl p-5 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs font-medium text-rose-700 mt-1">
                        Jámi 3 oyında utılǵanlar turnir menen xoshlasadı (bul shárt 6 roundqa túsken komandalarǵa
                        tiyisli bolmaydı olar ushın 3-3 balanstaǵılar 1/4 finalǵa, 2-4 bolǵanlar turnirden ketedi).
                    </p>
                </div>
            </div>
